...
export APPTAINER_IMAGE="/home/lenovo/clearml/gromacs/gromacs_2023.2.sif"

# Gromacs working directory
export WORKDIR="/home/lenovo/clearml/gromacs/stmv_benchmark/GROMACS_heterogeneous_parallelization_benchmark_info_and_systems_JCP/stmv"
...
cd ${WORKDIR}
apptainer run --nv \
       --bind /home/lenovo:/home/lenovo:rw \
       ${APPTAINER_IMAGE} \
