...
bash_task.set_parameters(
    {
        ...
        "properties/memory_gb": args["num_gpus"],
    }
)

# Enqueue the new task to the queue requested in the application wizard (we assume there is a slurm agent
# monitoring that queue)
